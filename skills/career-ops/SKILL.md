...
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/modes/`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/templates/`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/batch/batch-prompt.md`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/generate-pdf.mjs`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/merge-tracker.mjs`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/verify-pipeline.mjs`
...
If `config/profile.yml` is missing, copy the package template from `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/config/profile.example.yml` and then ask:
...
If `portals.yml` is missing, copy the package template from `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/templates/portals.example.yml` and ask whether the search keywords should be customized for the target roles.
...
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/modes/_shared.md`
- `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/modes/{mode}.md`
...
- For batch automation, use `/home/ghost/.dotfiles/opencode/.config/opencode/career-ops/batch/batch-runner.sh` or `opencode run --command career-ops ...`, never `claude -p`.
