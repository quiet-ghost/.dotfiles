...
- Expected values must come from an independent source of truth: a known-good literal, worked example, specification, or oracle. Avoid tautological tests that recompute the implementation in the assertion.
