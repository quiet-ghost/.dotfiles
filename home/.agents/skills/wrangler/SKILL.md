...
If Wrangler is not installed, ask before changing project dependencies. After approval, install a reviewed v4 release using the project's package manager. For example:
