...
xmodmap ~/.dotfiles/extras/keyboard/.Xmodmap
...
echo "  exec-once = xmodmap ~/.dotfiles/extras/keyboard/.Xmodmap"
echo ""
echo "Or add to your ~/.bashrc or ~/.zshrc:"
echo "  xmodmap ~/.dotfiles/extras/keyboard/.Xmodmap 2>/dev/null || true"
