...
Ejecutar como subagente si ayuda a no consumir contexto del main:

```
Task(description="career-ops scan", subagent_type="general", prompt="[contenido de este archivo + datos específicos]")
```
